...
UPDATE public.packages SET price_from_aud = 1950 WHERE slug = 'avelora-discovery' AND price_from_aud IS NULL;
UPDATE public.packages SET price_from_aud = 5450 WHERE slug = 'avelora-signature' AND price_from_aud IS NULL;
UPDATE public.packages SET price_from_aud = 7450 WHERE slug = 'avelora-romance' AND price_from_aud IS NULL;
