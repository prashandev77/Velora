...
import { FileText, CheckCircle, Info, RefreshCw, Layers, ShieldCheck, FileKey } from 'lucide-react';
import Link from 'next/link';
import { bookingTermsContent } from '@/lib/content';
...
const sectionIcons = [FileKey, Layers, ShieldCheck, CheckCircle, FileText, Info, RefreshCw];
const termsSections = bookingTermsContent.sections.map((s, i) => ({ icon: sectionIcons[i % sectionIcons.length], ...s }));
        ...
        <div className="min-h-screen bg-[#faf7f2]">
                ...
                <div className="relative max-w-5xl mx-auto px-6 md:px-12 pt-36 pb-20 md:pt-44 md:pb-28">
                    <motion.div {...fadeUp} className="text-center">
                        ...
                        <p className="text-stone-400 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                            {bookingTermsContent.hero.subtitle}
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="relative py-20 md:py-32">
                <div className="max-w-4xl mx-auto px-6 md:px-12">
                    ...
                    >
                        <p className="text-stone-500 mb-6 font-medium">{bookingTermsContent.footerNote}</p>
                        <Link
                            href="/contact"
