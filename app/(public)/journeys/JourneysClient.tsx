...
export default function JourneysClient({ packages }: { packages: Package[] }) {
    return (
                            ...
                            >
                                ...
                                <div className="relative w-full md:w-2/5 lg:w-1/3 aspect-[4/3] md:aspect-auto md:min-h-[310px]">
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <span className="bg-white/90 backdrop-blur-md text-stone-600 text-[10px] font-medium px-3 py-1.5 rounded-full capitalize">
                                            {pkg.category} Collection
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 p-6 md:p-8 lg:p-10 flex flex-col justify-center">
                                    ...
                                    <p className="text-stone-500 text-sm leading-relaxed mb-5 max-w-lg line-clamp-3">
                                        {pkg.description}
                                    </p>
